...
//        @JoinColumnOrFormula(column = @JoinColumn(name = "JOB_ID", referencedColumnName = "ID")),
//        @JoinColumnOrFormula(formula = @JoinFormula(value = "JOB_NOME", referencedColumnName = "NOME")) })
    @JoinTable(
        name = "PPW_PIPELINE_JOB",
